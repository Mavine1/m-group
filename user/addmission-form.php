...
<head>
  ...
  <title> M-Group Addmission Management System|| Addmission Form</title>
...
<option value="General">Engineering & Technology</option>
<option value="OBC">Business</option>
<option value="SC/ST">Education</option>
<option value="SC/ST">Medicine</option>
   </select>
...
<tr>
<th>Secondary School</th>
<td>   <input class="form-control white_bg" id="10thboard" name="10thboard" placeholder="Secondary School"  type="text" required></td>
...
<tr>
<th>Primary School</th>
<td>   <input class="form-control white_bg" id="12thboard" name="12thboard" placeholder="Primary school"  type="text" required></td>
