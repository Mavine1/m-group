...
<head>
  ...
  <title>M-Group Technical College-Admin Profile</title>
...
<div class="col-xl-6 col-lg-12">
 <fieldset>
  <h5>User Name                 </h5>
   ...
   <input class="form-control white_bg" id="username" name="username" value="<?php  echo $row['AdminuserName'];?>"  readonly='false' type="text" required>
                          </div>
                        </fieldset>
                      </div>
                    </div>
